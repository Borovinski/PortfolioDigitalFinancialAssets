      ...
      <Table className="px-5 border-t relative">
        <TableHeader>
          <TableRow className="sticky top-0 left-0 right-0 bg-background">
            <TableHead className="py-4 text-left">Монета</TableHead>
            <TableHead className="text-center">Символ</TableHead>
            <TableHead className="text-center">Объем</TableHead>
            <TableHead className="text-center">Рынок</TableHead>
            <TableHead className="text-center">24Ч</TableHead>
