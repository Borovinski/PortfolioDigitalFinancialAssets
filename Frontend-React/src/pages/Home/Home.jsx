          ...
          {category === "all" && (
            <Pagination className="border-t py-3">
              <PaginationContent>
                ...
                {page > 3 && (
                  <PaginationItem>
                    <PaginationLink onClick={() => handlePageChange(3)} isActive>
                      {page}
                    </PaginationLink>
                  </PaginationItem>
                )}
            ...
            <div className="h-[76%] flex flex-col overflow-y-auto gap-5 px-5 py-2 scroll-container">
              <div className="self-start pb-5 w-auto">
                <div className="justify-end self-end px-5 py-2 rounded-md bg-slate-800 w-auto">
                  ...
                  <p>Ты можешь задать любой вопрос о криптовалютах.</p>
                  <p>Например: цена, рыночная капитализация и т.д.</p>
                </div>
              </div>
              ...
              {chatBot.loading && <p>Загрузка данных...</p>}
            </div>
        ...
        >
          <Button className="w-full h-[3rem] gap-2 items-center">
            <MessageCircle
              ...
              size={30}
            />
            <span className="text-2xl">Чат-бот</span>
          </Button>
        </div>
      </section>
    </div>
