  ...
  if (!withdrawal.paymentDetails) {
    return (
      <div className="h-[20rem] flex gap-5 flex-col justify-center items-center">
        <p className="text-2xl font-bold">Добавьте способ оплаты</p>
        <Button onClick={() => navigate("/payment-details")}>
          Добавить реквизиты оплаты
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="pt-10 space-y-5">
      ...
      <div className="flex flex-col items-center">
        <h1 className="">Введите сумму для вывода</h1>
      ...
      <div>
        <p className="pb-2">Перевести на</p>
      ...
      <DialogClose className="w-full">
        ...
        >
          Вывести {amount && <span className="ml-5">${amount}</span>}
        </Button>
      </DialogClose>
    </div>
  );
